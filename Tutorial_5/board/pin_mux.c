...
- {pin_num: '12', pin_signal: PIO0_30/FC1_TXD_SCL_MISO/SCT0_OUT3/CTIMER0_MAT2/CTIMER0_CAP2/ADC0_1, label: 'J9[2]/P0_30-ADC1', identifier: Encoder_Analog}
...
- {pin_num: '28', pin_signal: PIO1_8/FC7_TXD_SCL_MISO_WS/CTIMER1_MAT3/CTIMER1_CAP3/ADC0_11, label: 'J1[12]/J9[6]/P1_8-ADC11-FC7_TXD_SCL_MISO_FRAME', identifier: Potenciometer}
...
- pin_list:
  - {pin_num: '28', peripheral: ADC0, signal: 'CH, 11', pin_signal: PIO1_8/FC7_TXD_SCL_MISO_WS/CTIMER1_MAT3/CTIMER1_CAP3/ADC0_11}
...
void BOARD_InitPins_cm4(void)
{
    ...
    IOCON->PIO[1][8] = ((IOCON->PIO[1][8] &
                        ...
                        /* Selects pin function.
                         * : PORT18 (pin 28) is configured as ADC0_11. */
                        | IOCON_PIO_FUNC(PIO18_FUNC_ALT0)

                        /* Selects function mode (on-chip pull-up/pull-down resistor control).
                         * : Inactive.
                         * Inactive (no pull-down/pull-up resistor enabled). */
                        | IOCON_PIO_MODE(PIO18_MODE_INACTIVE)

                        /* Select Analog/Digital mode.
                         * : Analog mode. */
                        | IOCON_PIO_DIGIMODE(PIO18_DIGIMODE_ANALOG));
}
