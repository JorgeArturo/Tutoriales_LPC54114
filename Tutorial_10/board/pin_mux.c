...
- {pin_num: '45', pin_signal: PIO0_10/FC2_SCK/SCT0_OUT3/CTIMER3_MAT0, label: 'J2[11]/P0_10-FC2_SCK-CT32B3_MAT0', identifier: DHT11_Sensor}
...
- pin_list:
  - {pin_num: '45', peripheral: GPIO, signal: 'PIO0, 10', pin_signal: PIO0_10/FC2_SCK/SCT0_OUT3/CTIMER3_MAT0, direction: OUTPUT, gpio_init_state: 'true', mode: pullUp,
    glitch_filter: enabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins_cm4(void)
{
    ...
    gpio_pin_config_t DHT11_Sensor_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PIO0_10 (pin 45)  */
    GPIO_PinInit(BOARD_DHT11_Sensor_GPIO, BOARD_DHT11_Sensor_PORT, BOARD_DHT11_Sensor_PIN, &DHT11_Sensor_config);
    ...
    IOCON->PIO[0][10] =
        ((IOCON->PIO[0][10] &
         ...
         | IOCON_PIO_FILTEROFF(PIO010_FILTEROFF_ENABLED));
}
