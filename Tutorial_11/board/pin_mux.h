...
/*!
 * @brief MCLK direction control.: The MCLK function is an output. */
#define MCLKIO_DIR_OUTPUT 0x01u
/*!
...
/*! @name PIO0_30 (number 12), J9[2]/P0_30-ADC1
  @{ */
#define BOARD_VSYNC_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_VSYNC_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_VSYNC_PIN 30U   /*!<@brief 0U pin index: 30 */
                              /* @} */

/*! @name PIO1_8 (number 28), J1[12]/J9[6]/P1_8-ADC11-FC7_TXD_SCL_MISO_FRAME
  @{ */
#define BOARD_HREF_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_HREF_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_HREF_PIN 8U    /*!<@brief 1U pin index: 8 */
                             /* @} */

/*! @name PIO1_4 (number 18), J2[18]/J9[10]/P1_4-ADC7-PDM1_CLK-FC7_RTS-FC3_TXD
  @{ */
#define BOARD_PCLK_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_PCLK_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_PCLK_PIN 4U    /*!<@brief 1U pin index: 4 */
                             /* @} */

/*! @name PIO0_8 (number 43), J2[15]/P0_8-FC2_RXD_SDA_MOSI
  @{ */
#define BOARD_D0_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_D0_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_D0_PIN 8U    /*!<@brief 0U pin index: 8 */
                           /* @} */

/*! @name PIO0_9 (number 44), J2[13]/P0_9-FC2_TXD_SCL_MISO
  @{ */
#define BOARD_D1_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_D1_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_D1_PIN 9U    /*!<@brief 0U pin index: 9 */
                           /* @} */

/*! @name PIO0_10 (number 45), J2[11]/P0_10-FC2_SCK-CT32B3_MAT0
  @{ */
#define BOARD_D2_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_D2_PORT 0U   /*!<@brief PORT device name: 0U */
#define BOARD_D2_PIN 10U   /*!<@brief 0U pin index: 10 */
                           /* @} */

/*! @name PIO1_12 (number 51), J2[9]/P1_12-CT32B1_MAT0-ACCl_INT1
  @{ */
#define BOARD_D3_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_D3_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_D3_PIN 12U   /*!<@brief 1U pin index: 12 */
                           /* @} */

/*! @name PIO1_13 (number 54), J2[7]/P1_13-CT32B1_MAT1
  @{ */
#define BOARD_D4_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_D4_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_D4_PIN 13U   /*!<@brief 1U pin index: 13 */
                           /* @} */

/*! @name PIO1_0 (number 14), J2[3]/P1_0-PDM0_DATA-CT32B3_MAT1
  @{ */
#define BOARD_D5_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_D5_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_D5_PIN 0U    /*!<@brief 1U pin index: 0 */
                           /* @} */

/*! @name PIO1_14 (number 57), J2[1]/P1_14-SCTO7
  @{ */
#define BOARD_D6_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_D6_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_D6_PIN 14U   /*!<@brief 1U pin index: 14 */
                           /* @} */

/*! @name PIO1_16 (number 7), J1[19]/P1_16-CT32B0_MAT0-GYRO_INT1
  @{ */
#define BOARD_D7_GPIO GPIO /*!<@brief GPIO device name: GPIO */
#define BOARD_D7_PORT 1U   /*!<@brief PORT device name: 1U */
#define BOARD_D7_PIN 16U   /*!<@brief 1U pin index: 16 */
                           /* @} */

/*! @name PIO1_2 (number 16), J9[7]/JS8[1]/U5[1]/P1_2-FC5_SSEL3
  @{ */
#define BOARD_XCLK_PORT 1U /*!<@brief PORT device name: 1U */
#define BOARD_XCLK_PIN 2U  /*!<@brief 1U pin index: 2 */
                           /* @} */
