...
settings:
- {id: SYSCON.CLKOUTDIV.scale, value: '4', locked: true}
- {id: SYSCON.FXCOMCLKSEL4.sel, value: SYSCON.fro_12m}
- {id: SYSCON.MAINCLKSELA.sel, value: SYSCON.fro_hf}
- {id: SYSCON.MCLKCLKSEL.sel, value: SYSCON.fro_hf}
- {id: SYSCON.MCLKDIV.scale, value: '8', locked: true}
sources:
...
void BOARD_BootClockHSRUN(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivFxI2s0MClk, 8U, false);                  /*!< Set MCLKDIV divider to value 8 */
