...
void FLEXCOMM0_init(void) {
  ...
  USART_TransferCreateHandleDMA(FLEXCOMM0_PERIPHERAL, &FLEXCOMM0_USART_DMA_Handle, FLEXCOMM0_USART_CALLBACK, NULL, &FLEXCOMM0_TX_Handle, NULL);
}
